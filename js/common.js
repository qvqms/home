$(function() {
	...
	rightNav += "<li><a href='index.html' target='_blank'>edgebook</a></li>";
	rightNav += "<li><a href='html/about.html' target='_blank'>关于我</a></li>";
	rightNav += "<li><a href='https://space.bilibili.com/3493080911055200' target='_blank'>BILIBILI</a></li>";
	rightNav += "<li><a href='https://jq.qq.com/?_wv=1027&k=YEPBqVwy' target='_blank'>QQ群</a></li>";//可添加多行（链接）
	rightNav += "<hr>";
	rightNav += "<li class='qrBtn'><a href='404/index.html' target='_blank'>敬请期待</a></li>";
	rightNav += "<li class='qrBox'><img src='https://dl3.img.timecdn.cn/2022/09/18/qr.png' alt='Pure'/></li>";
	rightNav += "<hr>";
	rightNav += "<li><a href='https://qvqms.github.io/cmd/' target='_blank'>SYSTEM-CMD-WIN11</a></li>";
	rightNav += "</ul>";
	$("body")
		.append(rightNav);
	$(".ccRightNav")
